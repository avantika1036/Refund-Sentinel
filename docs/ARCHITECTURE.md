...
- [2. Non-goals and boundaries](#2-non-goals-and-boundaries)
- [3. Architecture overview](#3-architecture-overview)
- [4. Repository architecture](#4-repository-architecture)
- [5. Event and financial model](#5-event-and-financial-model)
- [6. Refund lifecycle reasoning](#6-refund-lifecycle-reasoning)
- [7. Structural graph](#7-structural-graph)
- [8. Behavioral confirmation](#8-behavioral-confirmation)
- [9. Deterministic rules](#9-deterministic-rules)
- [10. Feature architecture](#10-feature-architecture)
- [11. Machine-learning model card](#11-machine-learning-model-card)
- [12. Risk-score composition](#12-risk-score-composition)
- [13. Financial exposure architecture](#13-financial-exposure-architecture)
- [14. Evidence bundle](#14-evidence-bundle)
- [15. LLM boundary](#15-llm-boundary)
- [16. API and frontend architecture](#16-api-and-frontend-architecture)
- [17. Threat model](#17-threat-model)
- [18. Reliability and failure handling](#18-reliability-and-failure-handling)
- [19. Privacy and fairness](#19-privacy-and-fairness)
- [20. Data card](#20-data-card)
- [21. Reproducibility and auditability](#21-reproducibility-and-auditability)
